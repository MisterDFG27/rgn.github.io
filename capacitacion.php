...
<head>
    ...
    <!-- Template Stylesheet -->
    <link href="css/stylecapa.css" rel="stylesheet">
    <link href="css/stylemarcas.css" rel="stylesheet">
        ...
        <div class="row gx-0">
            ...
            <div class="col-lg-4 text-center text-lg-end">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    ...
                    <a class="btn btn-sm btn-outline-light btn-sm-square rounded-circle me-2" href="admin/index.php"><i class="fa fa-user fw-normal"></i></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="bienes.php" class="nav-item nav-link">Bienes Raíces</a>
                    <a href="capacitacion.php" class="nav-item nav-link active">Capacitaciones</a>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Trainings / Capacitaciones</h1>
                </div>
            </div>
        </div>
    </div>
...
<?php include('includes/bodycapacitacion.php');  ?>

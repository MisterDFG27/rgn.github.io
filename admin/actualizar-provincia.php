...
//Armamos el query para seleccionar el provincia
...
if (isset($_GET['modificar'])) {
    ...
    $query = "UPDATE provincia SET nombre_provincia='$nombre_provincia' WHERE id='$id'" ;

    //actualizamos en la tabla provincia
    if (mysqli_query($conn, $query)) { //Se actualizo correctamente
        $mensaje = "El provincia se actualizó correctamente";
    } else {
...
<body>
    ...
    <div id="contenedor-admin">
        ...
        <div class="contenedor-principal">
            <!-- utilizamos el id de nuevo-tipo-provincia para aprovechar los estilos ya creados -->
            <div id="nuevo-provincia">
                ...
                <div class="box-nuevo-tipo">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="get">
                        ...
                        <input type="text" name="nombre_provincia" value="<?php echo $provincia['nombre_provincia'] ?>" placeholder="Nombre del provincia" required>

...
/********************************************************/
//SELECCIONAMOS LAS canton
//nos conectamos a la base de datos
include("conexion.php");

//Armamos el query para seleccionar los provincia
$query = "SELECT * FROM canton WHERE id_provincia='$propiedad[provincia]'";
        ...
        <div class="contenedor-principal">
            ...
            <div id="actualizar-propiedad">
                ...
                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data" method="post">
                    ...
                    <div class="fila">
                        <div class="box">
                            <label for="provincia"> País de la Propiedad</label>
                            <select name="provincia" id="" onchange="muestraselect(this.value)" class="input-entrada-texto">
                                <?php while ($row = mysqli_fetch_assoc($resultado_provincia)) : ?>
                                    <?php if ($row['id'] == $propiedad['provincia']) : ?>
                                        <option value="<?php echo $row['id'] ?>" selected>
                        ...
                        <div class="box">
                            <label for="canton">canton de la propiedad</label>
                            <select name="canton" id="canton" class="input-entrada-texto">
                                <?php while ($row = mysqli_fetch_assoc($resultado_canton)) : ?>
                                    <?php if ($row['id'] == $propiedad['canton']) : ?>
                                        <option value="<?php echo $row['id'] ?>" selected>

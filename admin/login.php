...
<body>
    <div id="contenedor-login">
        <div class="presentacion">
            <div class="titulo">
                <h1>RGN-Login</h1>
                <p>Sistema de Administración de Bienes Raices</p>
            </div>
            <div class="contenedor-formulario">
                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" class="form-login">
                    <p style="text-align: center; font-weight: bold;">Iniciar sesión</p>
                    ...
                    <input type="submit" value="Entrar" name="iniciar" class="btn">

        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="service.html" class="nav-item nav-link">Manejo de marcas</a>
                    <a href="service.html" class="nav-item nav-link">Seguridad</a>
            </div>
        </nav>
          ...
          <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    ...
                    <a href="" class="h5 text-white">Casas, campos, fincas, lotes, condominios al mejor precio.</a>
                </div>
            </div>
        </div>
    </div>
...
<?php include('includes/bodypublicacion.php');  ?>
